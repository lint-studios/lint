    ...
    <Card className="p-6 bg-surface-card border border-border-subtle">
      <div className="flex items-start justify-between">
        <div className="flex-1">
          <p className="text-mono-label font-mono text-text-secondary mb-2 uppercase tracking-wide">
            {title}
          </p>
          <p className="text-display-l font-display font-semibold text-text-primary mb-1">
            {value}
          </p>
          {trend && trendValue && (
