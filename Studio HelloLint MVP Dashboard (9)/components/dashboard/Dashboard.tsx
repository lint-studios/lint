...
function ReportCard({ title, date, status, highlights }: {
  ...
  return (
    <Card className="p-6 bg-surface-card border border-border-subtle rounded-2xl shadow-sm hover:shadow-md transition-shadow">
      ...
      <Button variant="outline" className="w-full font-medium rounded-xl border-accent text-accent hover:bg-accent hover:text-white">
    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          ...
          <Button variant="outline" className="font-medium rounded-xl border-secondary text-secondary hover:bg-secondary hover:text-white">
            View all reports
