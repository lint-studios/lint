  ...
  return (
    <header className="h-16 bg-surface-card border-b border-border-subtle flex items-center justify-between px-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <Button
          variant="ghost"
          className="flex items-center space-x-3 h-auto p-2 rounded-xl hover:bg-gray-50"
        >
          ...
          <div className="text-left hidden sm:block">
            <div className="text-body-s font-medium text-text-primary">
              John Doe
            </div>
            <div className="flex items-center space-x-2">
              <Badge className="gradient-lint text-white text-mono-label font-mono px-2 py-0.5 rounded-md border-0 text-[rgba(255,255,255,1)]">
                Beta
              </Badge>
            </div>
          </div>
